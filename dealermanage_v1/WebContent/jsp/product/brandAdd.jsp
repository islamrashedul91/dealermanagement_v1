...
%>	
	<form action="BrandController" method="post" name="frmSave">
		<div class="form-style-2-heading">Provide your information</div>
			...
			%>
			<label for="field16"><span>Created <span class="required">*</span></span>
				<input type="text" class="input-field" readonly="readonly" name="created" id="created" value="${brand.created}"  maxlength=14 size=40 required /> 
			</label>
			<%
			}
			%>
			...
			<label for="field17"><span>Updated </span>
				<input type="text" class="input-field" readonly="readonly" name="updated" id="updated" value="${brand.updated}"  maxlength=14 size=40 /> 
			</label>
			<%
			} else if (action.equalsIgnoreCase("edit")) {
			%>
