	...
	<form action="SalesmanInfoController" method="post" name="frmSave">
		<div class="form-style-2-heading">Provide your information</div>
			...
			<label for="field5"><span>Salesman Since <span class="required">*</span></span>
				<input type="text" class="input-field-60" readonly="readonly" name="salesman_start_date" id="salesman_start_date" value="<%=strDate%>"  maxlength=14 size=40 required /> 
			</label>
			<%
			} else if (action.equalsIgnoreCase("edit")) {
			%>
			<label for="field5"><span>Salesman Since <span class="required">*</span></span>
				<input type="text" class="input-field-60" readonly="readonly" name="salesman_start_date" id="salesman_start_date" value="${salesmanInfo.salesman_start_date}"  maxlength=14 size=40 required /> 
			</label>
			<%
			}
			%>
			...
			%>
			<label for="field19"><span>Created <span class="required">*</span></span>
				<input type="text" class="input-field-60" readonly="readonly" name="created" id="created" value="${salesmanInfo.created}"  maxlength=14 size=40 required /> 
			</label>
			<%
			}
			%>
			...
			<label for="field20"><span>Updated </span>
				<input type="text" class="input-field-60" readonly="readonly" name="updated" id="updated" value="${salesmanInfo.updated}"  maxlength=14 size=40 /> 
			</label>
			<%
			} else if (action.equalsIgnoreCase("edit")) {
			%>
