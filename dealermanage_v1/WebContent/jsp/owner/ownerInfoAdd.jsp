	...
	<form action="OwnerInfoController" method="post" name="frmSave">
		<div class="form-style-2-heading">Provide your information</div>
			...
			<label for="field5"><span>Owner Since <span class="required">*</span></span>
				<input type="text" class="input-field-60" readonly="readonly" name="owner_start_date" id="owner_start_date" value="<%=strDate%>"  maxlength=14 size=40 required /> 
			</label>
			<%
			} else if (action.equalsIgnoreCase("edit")) {
			%>
			<label for="field5"><span>Owner Since <span class="required">*</span></span>
				<input type="text" class="input-field-60" readonly="readonly" name="owner_start_date" id="owner_start_date" value="${ownerInfo.owner_start_date}"  maxlength=14 size=40 required /> 
			</label>
			<%
			}
			%>
			...
			<label for="field9"><span>Date of Birth <span class="required">*</span></span>
				<input type="text" class="input-field-60" name="dob" id="dob" value="${ownerInfo.dob}"  maxlength=25 size=40 required /> 
			</label>
			...
			%>
			<label for="field20"><span>Created <span class="required">*</span></span>
				<input type="text" class="input-field-60" readonly="readonly" name="created" id="created" value="${ownerInfo.created}"  maxlength=14 size=40 required /> 
			</label>
			<%
			}
			%>
			...
			<label for="field21"><span>Updated </span>
				<input type="text" class="input-field-60" readonly="readonly" name="updated" id="updated" value="${ownerInfo.updated}"  maxlength=14 size=40 /> 
			</label>
			<%
			} else if (action.equalsIgnoreCase("edit")) {
			%>
