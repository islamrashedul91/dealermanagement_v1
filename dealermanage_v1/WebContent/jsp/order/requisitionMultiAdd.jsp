...
%>	
	<form action="RequisitionMultiController" method="post" name="frmSave">
		<div class="form-style-2-heading">Provide your information </div>
			...
			%>
			<label for="field2"><span>DateTime <span class="required">*</span></span>
				<input type="text" class="input-field-60" readonly="readonly" name="date_time" id="date_time" value="${requisitionMulti.date_time}"  maxlength=14 size=40 required /> 
			</label>
			<%
			}
			%>
			...
			%>
			<label for="field13"><span>Created <span class="required">*</span></span>
				<input type="text" class="input-field-60" readonly="readonly" name="created" id="created" value="${requisitionMulti.created}"  maxlength=14 size=40 required /> 
			</label>
			<%
			}
			%>
			...
			<label for="field14"><span>Updated </span>
				<input type="text" class="input-field-60" readonly="readonly" name="updated" id="updated" value="${requisitionMulti.updated}"  maxlength=14 size=40 /> 
			</label>
			<%
			} else if (action.equalsIgnoreCase("edit")) {
			%>
