...
%>	
	<form action="PurchaseMainController" method="post" name="frmSave">
		<div class="form-style-2-heading">Provide your information </div>
			...
			%>
			<label for="field3"><span>DateTime <span class="required">*</span></span>
				<input type="text" class="input-field-60" readonly="readonly" name="date_time" id="date_time" value="${purchaseMain.date_time}"  maxlength=14 size=40 required /> 
			</label>
			<%
			}
			%>
			...
			%>
			<label for="field15"><span>Created <span class="required">*</span></span>
				<input type="text" class="input-field-60" readonly="readonly" name="created" id="created" value="${purchaseMain.created}"  maxlength=14 size=40 required /> 
			</label>
			<%
			}
			%>
			...
			<label for="field16"><span>Updated </span>
				<input type="text" class="input-field-60" readonly="readonly" name="updated" id="updated" value="${purchaseMain.updated}"  maxlength=14 size=40 /> 
			</label>
			<%
			} else if (action.equalsIgnoreCase("edit")) {
			%>
